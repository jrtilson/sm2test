...
<body style='font-size:2em;'>
	...
	<strong>PHP Delivered:</strong>
	<a href='#' onclick='javascript:playhtml5sound("podcast/bunny.mp3")'>mp3</a> | 
	<a href='#' onclick='javascript:playhtml5sound("podcast/bunny.m4a")'>m4a</a><br />
	<strong>Direct linked:</strong>
	<a href='#' onclick='javascript:playhtml5sound("bunny.mp3")'>mp3</a> | 
	<a href='#' onclick='javascript:playhtml5sound("bunny.m4a")'>m4a</a><br />
